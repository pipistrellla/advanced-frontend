...
const testData:Article[] = [
    ...
    {
        id: '1',
        title: 'Javascript news adawdasd awd adsawdsa wd a',
        subtitle: 'Что нового в JS за 2024 год?',
        img: 'https://teknotower.com/wp-content/uploads/2020/11/js.png',
        views: 1022,
        createdAt: '26.02.2024',
        type: [
            ArticleType.IT, ArticleType.ECONOMICS, ArticleType.SCIENCE, ArticleType.SCIENCE,
        ],
        blocks: [
            {
                id: '1',
